...
var key = builder.Configuration.GetSection("Jwt").Value ?? "minimal-api-secret-key-1234567890-abcdef";
if (string.IsNullOrEmpty(key)) key = "minimal-api-secret-key";
...
ErrosDeValidacao validaDTO(VeiculoDTO veiculoDTO)
{
    ...
    if (veiculoDTO.Ano < 1950 || veiculoDTO.Ano > 2026)
        validacao.Mensagens.Add("Informe um ano válido para o veículo.");
